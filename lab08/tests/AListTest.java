...
//     Uncomment the below if you want to test locally.
   ...
   public void testHasNext() {
       ...
       assertWithMessage("Iterator should be empty for an empty AList so hasNext() should return false").that(it1.hasNext()).isFalse();
       a.addLast(1);
       a.addLast(2);
       a.addLast(3);
   ...
   public void testNext() {
       ...
       assertWithMessage("Iterator should be empty so hasNext() should return false").that(it.hasNext()).isFalse();
   }
   ...
   public void testIteratorIndependence() {
       ...
       i1.next();
       i1.next();
       assertWithMessage("i1 should have no elements left so hasNext() should return false").that(i1.hasNext()).isFalse();
       assertWithMessage("i2 should have elements left so hasNext() should return true").that(i2.hasNext()).isTrue();
       ...
       assertWithMessage("i2 should have no elements left so hasNext() should return false").that(i2.hasNext()).isFalse();
       assertWithMessage("i1 should have no elements left so hasNext() should return false").that(i1.hasNext()).isFalse();
